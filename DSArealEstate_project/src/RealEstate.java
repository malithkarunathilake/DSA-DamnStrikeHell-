...
public class RealEstate {
	...
	ArrayList<estate_values> estateList; // make a arraylist for Estate class feilds
	...
	public RealEstate() {
		...
		initialize();
		estateList = new ArrayList<estate_values>();// instantiate arraylist
		displayedEstate = 0; // initialization
		//displayedEstate1 = 1;
	//disEstate = 0;
		estate_values e1 = new estate_values("1", "malith", "karunathilake", 120000, 350, 3); // make a instance as e1 from estateList
		estateList.add(e1);
